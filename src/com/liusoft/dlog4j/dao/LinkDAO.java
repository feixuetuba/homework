...
public class LinkDAO extends DAO {
	...
	public static List getLinksOfWapSite(SiteBean site, int fromIdx, int count){
		if(site == null)
			return null;
		return executeNamedQuery("LIST_WAP_LINKS", fromIdx, count, site.getId());
	}

	public static int getLinkCountOfWapSite(SiteBean site){
		if(site == null)
			return -1;
		return executeNamedStatAsInt("WAP_LINK_COUNT", site.getId());
	}
