...
public class SiteBean extends _BeanBase {
	...
	protected int status;			//网站状态 默认0为正常，4为不再首页出现此用户的文章，-1屏蔽，无法管理登录
	protected int flag;
	...
	protected List<CatalogBean> catalogs;
	...
	public static boolean isSuperior(SessionUserObject user){
		return UserLoginManager.isSuperior(user);
	}
...
///////////////////////////////////
	public String getFriend() {
		return getFunctionName().getFriend();
	}
	public void setFriend(String friend) {
		this.getFunctionName().setFriend(friend);
	...
	public String getCss() {
		return getStyle().getCss();
	}

	public String getLanguage() {
		return getStyle().getLanguage();
	}

	public String getLayout() {
		return getStyle().getLayout();
	}

	public String getLogo() {
		return getStyle().getLogo();
	}
	...
	public void setLanguage(String language) {
		getStyle().setLanguage(language);
	}

	public void setLayout(String layout) {
		getStyle().setLayout(layout);
	}

	public void setLogo(String logo) {
		getStyle().setLogo(logo);
