...
public class MessageBean extends _BeanBase {
    ...
    private UserBean fromUser;	//发送者
    private String fromUserName;	//发送者昵称
    private UserBean toUser;		//接收者
    private String content;		//留言内容
    private Date sendTime;		//留言发送时间
    private Date expiredTime;		//留言的失效时间(NEW:3.0版本新增)
    private Date readTime;		//留言阅读时间
    private int status;			//留言的当前状态
	...
	public void setFromUser(UserBean fromUser) {
		...
		if(fromUser!=null)
			this.fromUserName = fromUser.getNickname();
	}
