...
public abstract class _UserBeanBase extends _BeanBase {
	...
	/**
	 * 用户识别码,用于WAP的书签自动登录
	 * (Added by Winter Lau, 2006-10-21)
	 */
	...
	/**[角色]美工*/
	public final static int ROLE_STYLE = 0x03;//美工
	/**[角色]vip用户*/
	public final static int ROLE_VIP = 0x04;//vip
	/**无权限*/
	public final static int POPEDOM_COMMON = 0; //无权限
	/**所有权限*/
	public final static int POPEDOM_ALL = 1; //所有权限
	/**推荐 屏蔽权限*/
	public final static int POPEDOM_MANAGE = 2; //推荐 屏蔽权限
	/**修改 删除权限*/
	public final static int POPEDOM_OPERATE = 3; //修改 删除权限
	/**只有列表查看列表的访问权限*/
	public final static int POPEDOM_VISIT = 4; //只有列表查看列表的访问[暂定]
	/**顶级权限*/
	public final static int POPEDOM_SUPER = 5; //顶级权限 可对系统管理员 巡视者 VIP 普通用户 直接操作

	private String visitor;//访问者
	private String portraitIcon; //小头像
	private int popedom = POPEDOM_COMMON;//权限 默认普通用户
