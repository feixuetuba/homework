 ...
 * @author liudong
 */
public class _CommentBase extends _BeanBase {
	
	public final static int OWNER_TYPE_SITE = 0x00;
	public final static int OWNER_TYPE_CLUB = 0x01;
	...
	public int getOwnerIdent() {
		return ownerIdent;
	}

	public void setOwnerIdent(int ownerIdent) {
