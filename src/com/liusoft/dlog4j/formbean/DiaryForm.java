...
public class DiaryForm extends FormBean {
	...
	protected FormFile photo1;	//上传的照片
	...
	protected int annexValiDate ;//附件的验证id
	//圈子文章的属性
	private int lock;
	private int anonComment;
	...
	public int getAnonComment() {
		return anonComment;
	}

	public void setAnonComment(int anonComment) {
		this.anonComment = anonComment;
	}
	...
	public int getAnnexValiDate() {
		return annexValiDate;
	}

	public void setAnnexValiDate(int annexValiDate) {
		this.annexValiDate = annexValiDate;
	}
